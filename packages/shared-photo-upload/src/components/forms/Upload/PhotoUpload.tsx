...
import { Upload, Button, Row, Col, Image, App } from 'antd';
import { UploadOutlined, DeleteOutlined } from '@ant-design/icons';
import { getS3Operations } from '../../../lib/s3';
...
interface PhotoUploadProps {
  ...
  maxPhotos?: number;
  aspect?: 'square' | 'cover' | 'standard';
  uploadPath?: string; // Custom path for uploads (e.g., 'dog-photos', 'profile-photos')
}
      ...
      <ImageCropperModal
        ...
        onCropped={async (blob) => {
          ...
          try {
            ...
            const key = `${uploadPath}/${uuidv4()}.jpg`;
            const s3Ops = getS3Operations();
            const url = await s3Ops.uploadFile(croppedFile, key);
