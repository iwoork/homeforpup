...
const ManageWaitlistScreen: React.FC = () => {
  ...
  const handleMatchPuppy = (entry: WaitlistEntry) => {
    Alert.alert(
      'Match Puppy',
      `Match a puppy to ${entry.buyerName}?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Match',
    ...
    <View style={styles.entryCard}>
        ...
        {item.preferredGender && item.preferredGender !== 'no_preference' && (
          <View style={styles.detailRow}>
            <Icon
              ...
              size={16}
              color={
                item.preferredGender === 'male' ? '#3b82f6' : '#ec4899'
              }
            />
      ...
      <View style={styles.depositRow}>
        <View style={styles.depositInfo}>
          ...
          >
            {item.depositPaid
              ? `Deposit Paid ${item.depositAmount ? `($${item.depositAmount})` : ''}`
              : 'No Deposit'}
          </Text>
        </View>
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerSubtitle}>{litter.breed} Litter</Text>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.inputGroup}>
                <Text style={styles.inputLabel}>Preferred Color (Optional)</Text>
                <TextInput
                  style={styles.input}
