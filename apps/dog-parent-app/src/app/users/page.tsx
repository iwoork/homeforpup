...
export default function UsersIndexPage() {
  ...
  const [type, setType] = useState<'all' | 'breeder' | 'dog-parent' | 'both'>('all');
        ...
        <Row gutter={[12, 12]}>
          ...
          <Col xs={24} sm={12}>
            <Select value={type} onChange={setType} style={{ width: '100%' }}>
              ...
              <Select.Option value="dog-parent">Dog Parents</Select.Option>
                ...
                <List.Item.Meta
                  ...
                  title={
                    <Space>
                      ...
                      <Tag color={u.userType === 'breeder' ? 'green' : u.userType === 'dog-parent' ? 'blue' : 'purple'}>
                        {u.userType}
                      </Tag>
                    </Space>
                  }
